package loc.staproject.xo.view;

import java.util.InputMismatchException;
import java.util.Scanner;

import loc.staproject.xo.controllers.CurrentMoveController;
import loc.staproject.xo.controllers.MoveController;
import loc.staproject.xo.controllers.WinnerController;
...
public class ConsoleView {
    ...
    public boolean move(final Game game) {
        ...
        } catch (InvalidePointException | AlreadyOccupaiedException e) {
